...
public class TurtlePropertyScreen extends Application {
	...
	// private TurtlePropertiesActiveInactiveLabel
	// turtle_properties_active_inactive_label;
	...
	// private TurtlePropertiesPenThicknessLabel
	// turtle_properties_pen_thickness_label;
	...
	private void setLabels() {
		// turtle_properties_active_label = new TurtlePropertiesActiveLabel(new Label(),
		// root);
		// turtle_properties_active_inactive_label = new
		// TurtlePropertiesActiveInactiveLabel(new Label(), root);
		// turtle_properties_header_label = new TurtlePropertiesHeaderLabel(new Label(),
		// root);
		// turtle_properties_heading_label = new TurtlePropertiesHeadingLabel(new
		// Label(), root);
		// turtle_properties_id_label = new TurtlePropertiesIDLabel(new Label(), root);
		// turtle_properties_image_label = new TurtlePropertiesImageLabel(new Label(),
		// root);
		// turtle_properties_inactive_label = new TurtlePropertiesInactiveLabel(new
		// Label(), root);
		// turtle_properties_pen_color_label = new TurtlePropertiesPenColorLabel(new
		// Label(), root);
		// turtle_properties_pen_thickness_label = new
		// TurtlePropertiesPenThicknessLabel(new Label(), root);
		// turtle_properties_pen_up_down_label = new TurtlePropertiesPenUpDownLabel(new
		// Label(), root);
		// turtle_properties_position_label = new TurtlePropertiesPositionLabel(new
		// Label(), root);
		// turtle_properties_x_position_label = new TurtlePropertiesXPositionLabel(new
		// Label(), root);
		// turtle_properties_y_position_label = new TurtlePropertiesYPositionLabel(new
		// Label(), root);
		// turtle_properties_pen_up_label = new TurtlePropertiesPenUpLabel(new Label(),
		// root);
		// turtle_properties_pen_down_label = new TurtlePropertiesPenDownLabel(new
		// Label(), root);
	...
	private void setButtons() {
		new TurtlePropertiesOkButton(new Button(), root, myTurtle, turtle_image_combobox, pen_color_combobox,
				pen_down_radio_button, turtle_active_radio_button);
	}
