...
//    private static final int MM_HEADING_XLOC = new Display().getScreenWidth() / 2 - 220;
...
//    private static final int MM_SIM_XLOC = new Display().getScreenWidth() / 2 - 220;
//    private static final int MM_SIM_YLOC = 520;
//    private static final int MM_FILE_FONT_SIZE = 20;
//    private static final int MM_FILE_XLOC = new Display().getScreenWidth() / 2 - 159;
