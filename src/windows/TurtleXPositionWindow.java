...
public class TurtleXPositionWindow extends Windows {

	private Group myRoot;
	private static TextField text_field;
	private String full_directory_name = DIRECTORY_STRING + "turtle_x_position_window.properties";
	private static int x, y, width, height;
	private Turtle myTurtle;
	
	public TurtleXPositionWindow(Group root, Turtle turtle) {
		myRoot = root;
		myTurtle = turtle;
		initialize();
	}
...
//	  				E
	...
	protected void createWindow() {
		...
		text_field.setText(myTurtle.getXLocation() + "");
